...
**Forma 2: rename_at()**
se utiliza para para renombrar variables con determinados parámetros. En este caso, aquellas que comienzan con "C".
```{r}
# renombrar todas aquellas variables que comiencen con "c"
df %>% 
  rename_at(vars(starts_with("c")), ~ c("pais", "continente")) %>% 
  names()
```
Tanto "country" como "continent" fueron reemplazados por "pais" y "continente"
...
df$cyl <-  recode(df$cyl, c('"4" = "baja cilindrada";
                            "6" = "media cilindrada";
                            "8" = "alta cilindrada"'))
...
df$cyl_rec <-  recode(df$cyl, c('"4" = "baja cilindrada";
                                "6" = "media cilindrada";
                                "8" = "alta cilindrada"'))
