...
Para el ejemplo se pretende ponderar de acuerdo a las variables de: región, sexo, edad y educación. En este sentido, los valores que estimaremos como poblacionales de la región, el sexo y la edad los extraeremos de la BBDD de proyecciones del INE, mientras que los de educación los obtendremos desde la encuesta Casen 2020.

**Importante:** para construir este tipo de ponderador es necesario utilizar la BBDD de estimaciones y proyecciones poblaciones del INE, la cual se puede descargar en el siguiente [link]()
...
- BBDD a seleccionadas por el analista.
...
# como convención, los valores deben ser mayores a 0.3 y menores a 3
